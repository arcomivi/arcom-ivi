...
public:
    ...
    QString getSongPosition() { return m_sSongPosition; }
    QString getSongTitle(){ return m_sTitle; }
...
public slots:
    ...
    void setSongPosition(QString value){ m_sSongPosition=value; emit songPositionChanged(m_sSongPosition);}
    void setProgress(int value){ m_iProgress=value; emit progressChanged(m_iProgress); }
    void setSongTitle(QString value){ m_sTitle=value; emit songTitleChanged(m_sTitle);}
